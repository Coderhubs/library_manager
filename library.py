...
def add_book(title, author, year, genre, read_status, cover_image=None, book_link=None):
    ...
    cursor.execute("""
        INSERT INTO books (title, author, publication_year, genre, read_status, cover_image, book_link)
        VALUES (?, ?, ?, ?, ?, ?, ?)
    """, (title, author, year, genre, read_status, cover_path, book_link))
